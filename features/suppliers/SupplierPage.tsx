...
import { showImportSupplierModal } from './components/ImportSupplierModal';
import { useSupplierData } from './hooks/use-supplierdata';
...
export default function SupplierPage() {
  ...
  const {search, setSearch, suppliers, fetchNextPage, deleteWithId, loading, pagination} = useSupplierData()
  ...
  useEffect(() => {
    const handleScroll = async () => {
      ...
      if (div && loading === false && pagination.loading === false) {
                          ...
                          <DropdownMenuItem
                            ...
                            onClick={async () => {
                              await showSupplierModal({
                                ...
                                fetchNextPage(1, pagination.currentPage * 100);
                              });
                            }}
                          >
                            <Edit />
